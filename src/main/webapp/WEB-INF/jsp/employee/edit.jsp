								...
								<div class="col-md-2">
									<ul class="nav nav-pills nav-stacked">
										<li><a href='<c:url value="/employee/create"/>'><i
												class="fa fa-plus"></i> Add Emploee</a></li>
									</ul>
								</div>
								<div class="col-md-2">
									<ul class="nav nav-pills nav-stacked">
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<form:input path="name" type="text"
														placeholder="Enter Employee's name" cssClass="form-control"
														required="required" />
												</div>
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<form:input path="phone" type="text"
														placeholder="Enter phone number" cssClass="form-control"
														required="required" />
												</div>
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<form:input path="designation" type="text"
														placeholder="Enter designation/post" cssClass="form-control"
														required="required" />
												</div>
											...
											<div class="form-group">
												...
												<div class="input-group">
													...
													<form:input path="salary" type="text"
														placeholder="Enter salary" cssClass="form-control"
														required="required" />
												</div>
